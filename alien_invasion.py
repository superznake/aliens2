...
class AlienInvasion:
    def __init__(self):
        ...
        ost_path = resource_path("sound/ost.mp3")
        pygame.mixer.music.load(ost_path)
        pygame.mixer.music.set_volume(0.5)
        pygame.mixer.music.play(-1)
        self.pew_sound = pygame.mixer.Sound(resource_path("sound/pew.mp3"))
        self.pew_sound.set_volume(0.4)
        self.kill_sound = pygame.mixer.Sound(resource_path("sound/kill.mp3"))
        self.death_sound = pygame.mixer.Sound(resource_path("sound/death.mp3"))
